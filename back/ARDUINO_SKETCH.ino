...
void moveToFloor(int floor) {
  ...
  // Evitar mover si ya está en el piso
  if (floor == currentFloor) {
    Serial.print("OK:MOVING:FLOOR_");
  ...
  // ============================================
  // AQUÍ IMPLEMENTAR CONTROL DE MOTOR REAL
  // ============================================
  // Ejemplos:
  // - Calcular distancia: abs(floor - lastFloor)
  // - Activar motor: digitalWrite(MOTOR_UP/DOWN, HIGH)
  // - Esperar sensores de posición
  // - Frenar y parar cuando se alcance piso
  // - Usar PWM para control de velocidad: analogWrite(MOTOR_PIN, 255)
  
  // SIMULACIÓN: esperar 2 segundos por piso
  int distance = abs(floor - 1);  // Distancia desde piso anterior
  delay(2000 * distance);
  
  // Elevador llegó al piso
  elevatorState = "IDLE";
}
